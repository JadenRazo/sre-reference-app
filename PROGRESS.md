...
|---|---|---|---|---|---|
| 0 - Pre-flight + tool installs | in_progress | 2026-04-28 | | | awscli 2.34.38 + terraform 1.14.9 installed; AWS account creation pending |
...
| 3 - Terraform infra | pending | | | | blocked on AWS credentials |
